...
<?php echo form_open('logincontrolador/loginaeduc/'); ?>
<div class="Info">
   <p class="Titulo"><h1>Demo del script:   <a href="/logincontrolador-login/">¿Cómo hacer un login de usuarios en php y codeigniter?</a></h1></p>
   <p> </p>   
</div>
